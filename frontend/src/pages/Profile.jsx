          ...
          <div className="row mx-1 h-full">
            ...
            >
              ...
              <ul className="flex flex-col justify-center items-center p-0">
                <li className="text-center my-auto py-2 w-full">
                  <div>
                    {" "}
                    <div className="flex justify-center items-center p-2 fs-1 mb-2">
                      <FaUser className=" border rounded-full p-3 text-white text-7xl" />{" "}
                    </div>
                  </div>{" "}
                ...
                <li
                  id="account_left"
                  className={`text-center bg-[#f3f6f4] my-auto py-2 w-full ${activeProfilecss} hover:bg-[#005b96] hover:border hover:text-white`}
                ...
                <li
                  id="password_left"
                  className={`text-center bg-[#f3f6f4] my-auto hover:bg-[#005b96] hover:border hover:text-white py-2 w-full ${activePasswordcss}`}
                ...
                <li
                  id="workspace_left"
                  className={`text-center bg-[#f3f6f4] my-auto hover:bg-[#005b96] hover:border hover:text-white py-2 w-full ${activeWorkspacecss}`}
