      ...
      <div className="mx-[10%]">
        ...
        <div className="Search flex flex-row justify-center items-center mt-5">
          <input
            ...
            placeholder="Search"
          />
          <div className="serchicon w-[20%] sm:w-[15%] md:w-[10%] h-[37px] flex flex-col justify-around bg-[#005b96] hover:shadow-lg rounded-r-lg">
        ...
        <div className="mx-[10%] flex flex-row justify-between">
          <div className="text-3xl text-white">Search Results</div>
          <div className="">
            <div
              className="bg-[#005b96] text-white flex flex-row my-1 py-1 px-4 border rounded-lg"
            ...
            >
              ...
              <ul className="dropdown-menu">
                <li>
                  <div className="dropdown-item">A to Z</div>
                </li>
                <li>
                  <div className="dropdown-item">Z to A</div>
                </li>
                <li>
                  <div className="dropdown-item">Most visited</div>
                </li>
                <li>
                  <div className="dropdown-item">Latest to oldest</div>
                </li>
                <li>
                  <div className="dropdown-item">Oldest to latest</div>
                </li>
              </ul>
            </div>
          </div>
