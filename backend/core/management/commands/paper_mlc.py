...
path = 'C:\Program Files (x86)\chromedriver.exe'  # Replace with the actual path to safaridriver
...
driver.get("https://paperswithcode.com/search?q_meta=&q_type=&q=Machine+Learning")
